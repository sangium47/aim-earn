...
/**
 * Social provider brand icons, inlined as SVG React components.
 *
 * These replace the raster PNGs referenced by the Figma source — the Figma
 * CDN URLs expire after 7 days, and auth buttons benefit from crisp vector
 * marks that scale without artifacts.
 */
