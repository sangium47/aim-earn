...
const NAV_ITEMS: NavItem[] = [
  { label: "Dashboard", Icon: PieIcon, href: "/admin/dashboard" },
  {
    label: "Approval",
    Icon: ListChecks,
    collapsible: true,
  ...
  },
  {
    ...
    collapsible: true,
    children: [
      { label: "Distributor", href: "/admin/affiliate/distributor" },
      { label: "Affiliates", href: "/admin/affiliate/affiliates" },
      { label: "Suspend", href: "/admin/affiliate/suspend" },
    ],
  },
  { label: "Brands", Icon: Star, href: "/admin/brands" },
  { label: "Products", Icon: Tag, href: "/admin/products" },
  { label: "Orders", Icon: ShoppingCart, href: "/admin/orders" },
  { label: "Customers", Icon: UserIcon, href: "/admin/customers" },
  { label: "Payout", Icon: DollarSign, href: "/admin/payout" },
  {
    label: "User",
    Icon: UserCog,
    collapsible: true,
  ...
  { label: "Announcement", Icon: Bell, href: "/admin/announcement" },
  { label: "Support", Icon: HelpCircle, href: "/admin/support" },
  {
    ...
    children: [
      ...
      { label: "Notification", href: "/admin/setting/notification" },
    ],
  },
];
        ...
        <div ref={profileRef} className="relative">
          ...
          >
            ...
            <div className="hidden md:flex flex-col items-start gap-1 pr-1">
              ...
              <span className="text-xs leading-none text-[#757575]">Admin</span>
            </div>
            <ChevronDown
