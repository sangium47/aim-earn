...
import {
  ...
  BestSellingProducts,
  TopAffiliateMembers,
  TopRecruitmentByDistributor,
  TopRecruitmentByAffiliate,
  BottomPanel,
  BOTTOM_ROWS,
...
export default function DashboardPage() {
  return (
    <main className="flex flex-col gap-3 md:gap-6 p-3 md:p-6 lg:p-8">
      ...
      {/* Row: Business Performance + Affiliate Overview */}
      ...
      {/* Row: Top 10 Recruitment by Distributor + Top 10 Recruitment by Affiliate Member */}
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
        <TopRecruitmentByDistributor />
        <TopRecruitmentByAffiliate />
      </div>
